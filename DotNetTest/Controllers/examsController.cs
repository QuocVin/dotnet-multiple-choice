...
namespace DotNetTest.Controllers
{
    public class examsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Test([Bind(Include = "id,name,execution_time,start_time,expire_time,password,active,created_date,updated_date,subject_id,users_id")] exam exam)
        {
            if (ModelState.IsValid)
            {
                db.Entry(exam).State = EntityState.Modified;
